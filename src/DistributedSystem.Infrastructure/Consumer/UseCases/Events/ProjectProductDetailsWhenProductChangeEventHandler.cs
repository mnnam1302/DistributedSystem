...
internal class ProjectProductDetailsWhenProductChangeEventHandler
    : ICommandHandler<DomainEvent.ProductCreatedDomainEvent>,
    ICommandHandler<DomainEvent.ProductUpdatedDomainEvent>,
    ICommandHandler<DomainEvent.ProductDeletedDomainEvent>
{
    ...
    public async Task<Result> Handle(DomainEvent.ProductCreatedDomainEvent request, CancellationToken cancellationToken)
    {
    ...
    public async Task<Result> Handle(DomainEvent.ProductUpdatedDomainEvent request, CancellationToken cancellationToken)
    {
    ...
    public async Task<Result> Handle(DomainEvent.ProductDeletedDomainEvent request, CancellationToken cancellationToken)
    {
