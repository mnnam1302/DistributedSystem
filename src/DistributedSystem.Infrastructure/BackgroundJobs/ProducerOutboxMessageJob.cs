    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        foreach(OutboxMessage outboxMessage in messages)
        {
            ...
            try
            {
                ...
                {
                    case nameof(DomainEvent.ProductCreatedDomainEvent):
                        var productCreated = JsonConvert
                            .DeserializeObject<DomainEvent.ProductCreatedDomainEvent>(
                                outboxMessage.Content,
                                new JsonSerializerSettings
                                {
                    ...
                    case nameof(DomainEvent.ProductUpdatedDomainEvent):
                        var productUpdated = JsonConvert
                            .DeserializeObject<DomainEvent.ProductUpdatedDomainEvent>(
                                outboxMessage.Content,
                                new JsonSerializerSettings
                                {
                                    TypeNameHandling = TypeNameHandling.All
                    ...
                    case nameof(DomainEvent.ProductDeletedDomainEvent):
                        var productDeleted = JsonConvert
                            .DeserializeObject<DomainEvent.ProductDeletedDomainEvent>(
                                outboxMessage.Content,
                                new JsonSerializerSettings
                                {
                                    TypeNameHandling = TypeNameHandling.All
