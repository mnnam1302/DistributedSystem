...
namespace DistributedSystem.Domain.Abstractions.Repositories
{
    public interface IDapperRepositoryBase
    {
        ...
        Task<IEnumerable<TResult>> QueryMapAsync<TEntity1, TEntity2, TResult>(string sql, Func<TEntity1, TEntity2, TResult> map, object? param, string splitOn = "Id", CancellationToken cancellationToken = default);
    }
}